...
TwoViewReconstruction::TwoViewReconstruction(cv::Mat &K,
                                             float sigma,
                                             int iterations) {
    mK = K.clone();
...
bool TwoViewReconstruction::ReconstructH(vector<bool> &vbMatchesInliers,
    ...
    // We reconstruct all hypotheses and check in terms of triangulated points
    // and parallax
...
int TwoViewReconstruction::CheckRT(const cv::Mat &R,
                                   const cv::Mat &t,
...
void TwoViewReconstruction::DecomposeE(const cv::Mat &E,
                                       cv::Mat &R1,
                                       cv::Mat &R2,
                                       cv::Mat &t) {
    cv::Mat u, w, vt;
